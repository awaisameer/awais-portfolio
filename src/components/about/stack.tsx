...
const CHIPS: Chip[] = [
  ...
  { label: "C#", slug: "csharp", bg: "#68217A", fg: "#ffffff" },
  { label: "TypeScript", slug: "typescript", bg: "#2F74C0", fg: "#ffffff" },
  { label: "Angular", slug: "angular", bg: "#C3002F", fg: "#ffffff" },
  { label: "Java", slug: "openjdk", bg: "#1f1f1f", fg: "#ffffff" },
  { label: "SQL Server", slug: "microsoftsqlserver", bg: "#CC2927", fg: "#ffffff" },
  { label: "MongoDB", slug: "mongodb", bg: "#116149", fg: "#ffffff" },
