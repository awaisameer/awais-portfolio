...
export function ProjectsPage(): ReactNode {
  useDocumentMeta({
    title: "Projects",
    description:
      "Selected full stack, automation and AI projects built by Awais Ameer.",
  });
      ...
      <section className="mx-auto w-full max-w-275 px-6 pt-44 pb-16 sm:px-10 sm:pt-100 sm:pb-20">
        <FadeIn className="flex flex-col items-center gap-5 text-center">
          ...
          <p className="max-w-[33ch] text-[20px] leading-[1.4] tracking-tight text-foreground/65 sm:text-[22px]">
            Enterprise applications, automation platforms, and AI projects
            I&rsquo;m especially proud to have shipped.
          </p>
        </FadeIn>
      </section>
      <Projects />
